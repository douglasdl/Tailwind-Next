        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Dias Leal" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="douglas_san@hotmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Select placeholder="Select a timezone">
              <SelectItem
                value="jp"
                text="Japan Central Standard Time (UTC+09:00)"
              />
              <SelectItem value="br" text="Brasília Time - BRT (UTC-03:00)" />
            </Select>
          </div>
